                        ...
                        <ul>
                            ...
                            <li class="mb-4">
                                <label for="onsale" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" id="onsale" wire:model.live='onSale' value="1"
                                        class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <input type="range" wire:model.live='price_range'
                                ...
                                max="20000" value="100" step="200">
                            <div class="flex justify-between ">
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(100) }}</span>
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(20000) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
